VERSION 5.00
Begin VB.Form frmClientDetails 
   BackColor       =   &H8000000D&
   ...
   End
End
Attribute VB_Name = "frmClientDetails"
...
'-Loads current Client's details---------

On Error GoTo mistake
Data1.DatabaseName = mdlMain.ApplicPath & "/dbGenesis.mdb"
Data1.Refresh
If mdlMain.ClientIDDetails <> "" Then
Data1.RecordSource = "select * from tblClients where ID = " & mdlMain.ClientIDDetails & ";"
Data1.Refresh
End If
Exit Sub
mistake:
